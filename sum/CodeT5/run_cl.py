...
from ewc import *
from construct_exemplar import construct_exemplars_ours
from io import open
...
def main(args):
    ...
    if args.do_train:
        ...
        if args.task_id>0:
            train_replay_examples = read_examples(args.train_examplar_path, args)
            ...
            for epoch in range(args.num_train_epochs):
                ...
                if args.do_eval:
                    ...
                    if 'dev_loss' in dev_dataset:
                        ...
                        if args.task_id>0:
                            eval_replay_examples = read_examples(args.eval_examplar_path, args)
                            if 'emr' in args.mode_name or args.mode_name in ['hybird']:
