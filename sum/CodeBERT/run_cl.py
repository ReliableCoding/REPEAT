...
def main():
    ...
    if args.do_train:
        ...
        if args.task_id>0:
            ...
            if 'emr' in args.mode or args.mode in ['hybird']:
        ...
        if args.task_id>0:
            for epoch in range(args.num_train_epochs):
                ...
                if 'ewc' in args.mode and args.task_id>0:
                    ...
                    ewc = EWC(model, replay_dataloader, device, len(replay_examples))
        ...
        if 'emr' in args.mode or 'ewc' in args.mode or args.mode in ['hybird']:
            construct_exemplars_ours(model_to_save,args,origin_train_examples,origin_eval_examples,tokenizer,device,'random')
