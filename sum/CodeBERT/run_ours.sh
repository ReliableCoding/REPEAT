...
python run_cl.py --do_train --do_eval --model_type roberta --model_name_or_path $pretrained_model --load_model_path $load_model_path --mode $name --train_replay_size $train_replay_size --train_examplar_path $train_examplar_path --eval_examplar_path $dev_examplar_path --ewc_weight $weight --task_id 0 --k $k  --mu $mu --train_filename $train_file --dev_filename $dev_file --output_dir $output_dir --max_source_length $source_length --max_target_length $target_length --beam_size $beam_size --train_batch_size $batch_size --eval_batch_size $batch_size --learning_rate $lr  --num_train_epochs $num_train_epochs
...
python run_cl.py --do_train --do_eval --model_type roberta --model_name_or_path $pretrained_model --load_model_path $load_model_path --mode $name --train_replay_size $train_replay_size --train_examplar_path $train_examplar_path --eval_examplar_path $dev_examplar_path --ewc_weight $weight --task_id 1 --k $k  --mu $mu --train_filename $train_file --dev_filename $dev_file --output_dir $output_dir --max_source_length $source_length --max_target_length $target_length --beam_size $beam_size --train_batch_size $batch_size --eval_batch_size $batch_size --learning_rate $lr  --num_train_epochs $num_train_epochs
...
python run_cl.py --do_train --do_eval --model_type roberta --model_name_or_path $pretrained_model --load_model_path $load_model_path --mode $name --train_replay_size $train_replay_size --train_examplar_path $train_examplar_path --eval_examplar_path $dev_examplar_path --ewc_weight $weight --task_id 2 --k $k  --mu $mu --train_filename $train_file --dev_filename $dev_file --output_dir $output_dir --max_source_length $source_length --max_target_length $target_length --beam_size $beam_size --train_batch_size $batch_size --eval_batch_size $batch_size --learning_rate $lr  --num_train_epochs $num_train_epochs
...
python run_cl.py --do_train --do_eval --model_type roberta --model_name_or_path $pretrained_model --load_model_path $load_model_path --mode $name --train_replay_size $train_replay_size --train_examplar_path $train_examplar_path --eval_examplar_path $dev_examplar_path --ewc_weight $weight --task_id 3 --k $k  --mu $mu --train_filename $train_file --dev_filename $dev_file --output_dir $output_dir --max_source_length $source_length --max_target_length $target_length --beam_size $beam_size --train_batch_size $batch_size --eval_batch_size $batch_size --learning_rate $lr  --num_train_epochs $num_train_epochs
...
python run_cl.py --do_train --do_eval --model_type roberta --model_name_or_path $pretrained_model --load_model_path $load_model_path --mode $name --train_replay_size $train_replay_size --train_examplar_path $train_examplar_path --eval_examplar_path $dev_examplar_path --ewc_weight $weight --task_id 4 --k $k  --mu $mu --train_filename $train_file --dev_filename $dev_file --output_dir $output_dir --max_source_length $source_length --max_target_length $target_length --beam_size $beam_size --train_batch_size $batch_size --eval_batch_size $batch_size --learning_rate $lr  --num_train_epochs $num_train_epochs
