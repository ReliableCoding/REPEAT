...
def main():
    ...
    if args.do_test and args.local_rank in [-1, 0]:
        ...
        for idx in range(len(output_dir)):
            ...
            print('')
        print('Avg_ACC:',round(100*acc_sum/len(output_dir), 2))
        print('Avg_F1:',round(100*f1_sum/len(output_dir), 2))
        print('Avg_P:',round(100*p_sum/len(output_dir), 2))
        print('Avg_R:',round(100*r_sum/len(output_dir), 2))
