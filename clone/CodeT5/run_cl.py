        ...
        for idx, line in enumerate(f):
            ...
            examples.append(
                Example(
                    ...
                    source2=code2,
                    target=nl,
                    origin_source1=js['code1'],
                    origin_source2=js['code2'],
                    origin_target=js['label'],
                )
            )
    return examples
...
def main():
    ...
    model_config = T5Config.from_pretrained(args.model_name_or_path)
    model = T5ForConditionalGeneration.from_pretrained(args.model_name_or_path, config=model_config)
